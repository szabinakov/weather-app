...
const ForecastSummary = (props)=> {
    ...
    <div className='container'>
           <div className='date' data-testid='date-id'>{moment(props.date).format('dddd Do MMM')}</div>
            ...
            <WeatherIcon className='icon' data-testid='icon-id' name='owm' iconId={props.icon}/>
